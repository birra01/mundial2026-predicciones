        ...
        <div class="match-preview">
            ...
            <div class="preview-body">
                <div class="preview-content">
                    ...
                    <!-- LO QUE DICEN LAS CASAS (previas reales de internet) -->
                    <div class="preview-section">
                        <h3>🔍 Lo que dicen las casas de apuestas</h3>
                        <p class="form-note">Recopilado de previas reales publicadas hoy (Mundo Deportivo, AS, Sportytrader, TopMercato, SI.com, Racing Post). No es nuestro modelo.</p>
                        <div class="preview-table">
                            <div class="ptr"><div class="pl">Fuente</div><div class="pc">Pronóstico principal</div><div class="pr">Cuota / marcador</div></div>
                            <div class="ptr"><div class="ph">TopMercato</div><div class="pc">Ambos equipos marcan + Francia 2-1</div><div class="pa">BTTS 1.85 · 2-1 @7.80</div></div>
                            <div class="ptr"><div class="ph">AS</div><div class="pc">BTTS Sí / Over 1.5 goles</div><div class="pa">1-1 o 2-1</div></div>
                            <div class="ptr"><div class="ph">SI.com</div><div class="pc">Francia 2-1 España</div><div class="pa">2-1</div></div>
                            <div class="ptr"><div class="ph">Sportytrader</div><div class="pc">Francia se clasifica</div><div class="pa">—</div></div>
                            <div class="ptr"><div class="ph">Mundo Deportivo</div><div class="pc">Partido muy parejo</div><div class="pa">Fra 2.35 · Emp 3.25 · Esp 3.15</div></div>
                        </div>
                        <p style="margin-top:14px"><strong>Consenso:</strong> la mayoría apuesta a que <em>ambos marcan</em> (TopMercato, AS) y a un triunfo ajustado de Francia (SI.com, TopMercato, Sportytrader). El historial reciente favorece a España: 18 victorias vs 13 de Francia en 38 duelos, y ganó los 2 últimos (Euro 2024: 2-1; Nations League 2025: 5-4).</p>
                        <p style="margin-top:8px"><strong>Datos clave contrastados:</strong> Francia llega con 6V/6 (16 goles a favor, 2 en contra); Mbappé suma 8 goles en el torneo. España invicta, solo 1 gol encajado (De Ketelaere, vs Bélgica) tras 649' de Unai Simón sin recibir goles (récord Mundial).</p>
                    </div>
